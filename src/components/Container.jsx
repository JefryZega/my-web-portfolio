            ...
            <section id="home" className="hero grid grid-cols-1 md:grid-cols-2 mx-15 items-center md:gap-6 gap-7">
                <div>
                    ...
                    <div className="mt-10 flex gap-6">
                        <a href="https://drive.google.com/file/d/1-0-VcSyjeAEDctAr5w2ewgZURtgEbZ9E/view?usp=sharing" target="_blank" className="bg-blue-500 p-4 rounded hover:bg-blue-400 ">Resume</a>
